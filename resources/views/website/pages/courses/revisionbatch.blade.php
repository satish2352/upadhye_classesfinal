...
@section('content')
    ...
    <section class="page-header page-header--bg-two" data-jarallax data-speed="0.3" data-imgPosition="50% -100%">
        ...
        <div class="container text-center">
            <h2 class="page-header__title">Revision Batch</h2><!-- /.page-title -->
            <ul class="page-header__breadcrumb list-unstyled">
                <li><a href="index-2.html">Home</a></li>
                <li><span>Revision Batch</span></li>
                    ...
                    <div class="course-three__item">
                        <div class="course-three__content p-3">
                            ...
                            <div class="row pt-2">
                                ...
                                <div class="col-lg-9"><span class="course-details__overview__text">Daily 6 to 9 hours of studying.</span></div>
                            </div>
                            <hr>
                            ...
                            <div class="row ">
                                ...
                                <div class="col-lg-9"><span class="course-details__overview__text">This Batch is started from December to till May for 6 Months.</span></div>
                            </div>
                            <hr>
                            <div class="row ">
                                <div class="col-lg-3 d-flex align-items-center">

...
use App\Http\Repository\Admin\OurResult\OurResultCategoryRepository;

use App\OurResultCategory;
use Carbon\Carbon;


class OurResultCategoryServices
{
    ...
    {
        $this->repo = new OurResultCategoryRepository();
    }
